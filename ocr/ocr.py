...
"""
    ...
    article.append(str(corrected_text.correct()))
    os.remove("test_image.jpg")
    return article[0]
# ocr("https://firebasestorage.googleapis.com/v0/b/abstracto-db.appspot.com/o/7.jpg?alt=media&token=1814fdb8-869c-4ec5-892a-7bb7e781868b")
#
# print(article[0])